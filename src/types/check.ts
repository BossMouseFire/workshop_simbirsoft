...
export enum CheckActionTypes {
  ...
  Change_All_State = "Change_All_State",
}
...
export type CheckAction =
  | ChangeBabyChairAction
  | ChangeColorAction
  | ChangeFullTankAction
  | ChangeRightHandDriveAction
  | ChangePickUpPointAction
  | ChangeModelAction
  | ChangeTariffAction
  | ChangeLeaseAction
  | ChangePriceAction
